		...
		<div id="Form1" class="wrap">
			<div id="wrap" class="frm">
				...
				<div class="btn-group btn-group-justified" role="group"
					...
					<div class="btn-group" role="group">
						<a class="btn btn-default" href="<c:url value='/devNotes.do'/>" target="demoFrame">
							개발 노트
						</a>
					</div>
				</div>
				...
				<table cellspacing="10" cellpadding="10">
					...
					<tr>
							...
							<div class="panel-group" id="accordion">
										...
										<div class="panel-body">
											<div class="examples list-group">
												<c:if test="${sessionScope.typeSeq == 9}">
													<a href="<c:url value='/notice/list.do' />" class="list-group-item" target="demoFrame"> 공지사항 </a>
												</c:if>
												<a href="<c:url value='/board/list.do' />" class="list-group-item" target="demoFrame"> 자유게시판 </a>
												<a href="<c:url value='/board/gridList.do' />" class="list-group-item" target="demoFrame"> 자유게시판(Grid) </a>
											</div>
										</div>
									</div>
								</div>
								<c:if test="${sessionScope.typeSeq == 9}">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">관리자메뉴</a>
											</h4>
										</div>
										<div id="collapse2" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="examples list-group">
													<a href="<c:url value='/member/mList.do' />" class="list-group-item" target="demoFrame">
														회원관리
													</a>
												</div>
											</div>
						...
						<td style="vertical-align: top; width: 800px;">
							<%-- 우측 본문 --%> <iframe id="demoFrame" name="demoFrame" style="width: 803px; height: 800px; border-width: 0;"></iframe>
						</td>
					</tr>
				</table>
			</div>
