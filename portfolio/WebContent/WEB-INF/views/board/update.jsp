	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('#btnList').click(function(){
				window.location.replace("<c:url value='/board/read.do?boardSeq=${getBoard.board_seq}'/>");
			});
		});
	</script>
</head>
									...
									<c:forEach items="${files}" var="file" varStatus="vs">
										<tr>
											...
											<td colspan="3" style="text-align:left;">
												...
												<a href="<c:url value='/board/deleteAttach.do?fileIdx=${file.file_idx}&typeSeq=${getBoard.type_seq}&boardSeq=${getBoard.board_seq}'/>">
