	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$('#btnWrite').on('click', function(){
				...
				writeFormId.attr("action", "<c:url value='/board/write.do'/>");
				writeFormId.submit();
			});
		});
						...
						<fieldset>
							...
							<table summary="표 내용은 Ses & Food 글쓰기 박스입니다."
								...
								<tbody>
									...
									<c:forEach begin="1" end="3" step="1" var="cnt">
										<tr>
											<th class="tright"><label for="board_write_title">첨부파일${cnt}</label></th>
											<td class="tleft">
							...
							<div class="btn_bottom">
								<div class="btn_bottom_right">
									<input type="button" value="작성취소" title="작성취소" onclick="history.back();"/>
